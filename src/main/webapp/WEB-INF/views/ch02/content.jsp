   ...
   <div class="card-body">
      <div class="card m-2">
         ...
         <div class="card-body">
            ...
            <!-- <a href="${pageContext.request.contextPath}/ch02/method?bkind=free&bno=1" class="btn btn-info btn-sm">GET방식</a>  -->
            <form method = "get" action = "${pageContext.request.contextPath}/ch02/method">
            	bkind : <input type = "text" name = "bkind" value = "free" /> <br/>
            	bno : <input type = "text" name = "bno" value = "1" /> <br/>
            	<input type = "submit" value = "GET 방식" />
            </form>
            
            <form method = "post" action = "${pageContext.request.contextPath}/ch02/method">
            	bkind : <input type = "text" name = "bkind" value = "free" /> <br/>
            	bno : <input type = "text" name = "bno" value = "1" /> <br/>
