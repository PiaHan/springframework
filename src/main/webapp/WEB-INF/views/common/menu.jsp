...
<ul class="nav flex-column">
    <li class = "nav-item mb-2">
       <h6 class="text-white">
          ...
          <a href="${pageContext.request.contextPath}/ch01/content" class="text-white">
          컨트롤러와 뷰 작성
          </a>
       </h6>
    </li>
    ...
    <li>
       <h6 class="text-white">
          ...
          <a href="${pageContext.request.contextPath}/ch17/content" class="text-white">Spring Security</a>
       </h6>
    </li>
